...
public class ComputeTax{
    public static void main (String[]args){
        ...
        System.out.print("(1-single filer, 2-married jointly or " +
                "qualifying widow(er), 3-married separately, \n4-head of " +
        ...
        switch(status) {
            ...
            case 2: // Married jointly or qualifying widow(er)
                if (income <= 16700)
                    tax = income * 0.10;
